...
The Dockerfile pins a specific version of uv via `COPY --from=ghcr.io/astral-sh/uv:0.8.14`.
When upgrading uv, update this image tag in the Dockerfile to match.
